let handler = async (m, { conn }) => {
  ...
  try {
    ...
    switch (text) {
        ...
        case 'maldito teni':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'h
https://cdn.russellxz.click/ff876291.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
        ...
        case 'siuuu':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://files.catbox.moe/nilnkq.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
