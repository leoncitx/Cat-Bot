let handler = async (m, { conn }) => {
  ...
  try {
    ...
    switch (text) {
        ...
        case 'siuuu':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/8843afdb.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
        ...
        case 'teamo':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/b56c3bf6.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
        ...
        case 'feliz navidad':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/66c9a52f.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
        ...
        case 'marica tu':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/b0eb43ed.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
